...
CPU_state cpu = {.csrs.mstatus=0x1800};
...
static void trace_and_difftest(Decode *_this, vaddr_t dnpc) {
  ...
  if(check_wp_change() && nemu_state.state != NEMU_ABORT && nemu_state.state != NEMU_END){
    nemu_state.state = NEMU_STOP;
    printf("Tigger Watchpoint and program has stop running!\n");
  }
#endif
